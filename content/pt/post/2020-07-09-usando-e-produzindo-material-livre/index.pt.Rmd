...
title: "Usando e Produzindo Material Livre"
subtitle: "Licenças Creative Commons e outras licenças livres"
summary: ""
authors: 
  - fnaufel
tags:
...
categories:
  - software
  - culture
date: 2020-07-09T13:40:40-03:00
lastmod: 2020-07-09T13:40:40-03:00
featured: false
draft: false
...
```{r echo=FALSE}
knitr::include_graphics('420px-Copyrightstatusquestion.svg.png')
```
...
1. Como podemos usar material produzido por outras pessoas sem infringir direitos autorais?

2. Considerando que não somos egoístas e entendemos as dificuldades de quem precisa produzir e/ou transmitir conhecimento, como podemos disponibilizar o material que *nós* produzimos sem restringir excessivamente seu uso por outras pessoas?
...
::: {style="background-color: #eeeeee;"}
```{r echo=FALSE}
knitr::include_graphics('600px-Disney-infinite-copyright.svg.png')
```
:::
...
Sobre esta e outras manobras semelhantes, [Lawrence Lessig](https://pt.wikipedia.org/wiki/Lawrence_Lessig) escreveu no seu livro [*Free Culture*](http://www.free-culture.cc/freeculture.pdf):
...
[Lawrence Lessig](https://pt.wikipedia.org/wiki/Lawrence_Lessig) é um advogado americano, fundador da [Creative Commons](https://br.creativecommons.org/). Uma boa introdução ao seu trabalho pela reforma dos direitos autorais é esta *TED talk*, de 2007 (se quiser, configure para ver legendas em português). Mais informações sobre o vídeo, incluindo sua transcrição, no [site TED](https://www.ted.com/talks/lawrence_lessig_laws_that_choke_creativity).

<div style="max-width:854px">
<div style="position:relative;height:0;padding-bottom:56.25%">
<iframe src="https://embed.ted.com/talks/lawrence_lessig_laws_that_choke_creativity"  width="854" height="480" style="position:absolute;left:0;top:0;width:100%;height:100%" frameborder="0" scrolling="no" allowfullscreen>
</iframe>
</div>
</div>
...
Lessig também escreveu o livro [Free Culture](http://free-culture.cc/), disponível no [original em inglês](http://www.free-culture.cc/freeculture.pdf) e em uma [tradução em português](http://softwarelivre.org/articles/0018/5102/lawrence-lessig-cultura-livre.pdf), ambos, é claro, sob licença livre.

A organização Creative Commons tem um [site em português](https://br.creativecommons.org/), que explica como você pode usar e criar material sob diversos tipos de licenças livres, dentro da lei, sem se preocupar com a possibilidade de infringir direitos autorais.

As principais licenças Creative Commons são as seguintes (texto do [site brasileiro da CC](https://br.creativecommons.org/)):

* **Atribuição (CC BY)**

  ![](https://br.creativecommons.org/wp-content/uploads/2015/04/by.jpg)
...
* **Atribuição-CompartilhaIgual (CC BY-SA)**
  ...
  ![](https://br.creativecommons.org/wp-content/uploads/2015/04/by-sa.jpg)
...
* **Atribuição-SemDerivações (CC BY-ND)**
  ...
  ![](https://br.creativecommons.org/wp-content/uploads/2015/04/by-nd.jpg)
...
* **Atribuição-NãoComercial (CC BY-NC)**
  ...
  ![](https://br.creativecommons.org/wp-content/uploads/2015/04/by-nc.jpg)
...
* **Atribuição-NãoComercial-CompartilhaIgual (CC BY-NC-SA)**
  ...
  ![](https://br.creativecommons.org/wp-content/uploads/2015/04/by-nc-sa.jpg)
...
* **Atribuição-NãoComercial-SemDerivados (CC BY-NC-ND)**
  ...
  ![](https://br.creativecommons.org/wp-content/uploads/2015/04/by-nc-nd.jpg)
...
* **Domínio público (CC 0)**
  ...
  ![](Publicdomainsymbolversion1-scaled.jpeg)

  Nenhuma restrição.

No [site da Creative Commons](https://br.creativecommons.org/), você encontra links para o texto legal de todas as licenças. Não é necessário que o texto legal esteja incluído na obra. Para que ocorra o efeito legal, basta que o autor declare que o material está sendo disponibilizado sob uma dessas licenças.
...
1. Incluir no seu trabalho as atribuições aos autores dos trabalhos que você usou, se eles assim exigem (e nada impede que você também inclua atribuições aos autores que não as exigem).

2. Incluir a licença que você está estipulando para o seu trabalho.
